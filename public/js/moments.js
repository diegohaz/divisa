...
m[0].scenes[0].foregrounds = [
  // new Item('/img/m0/box.png', 247/13, 373/13, 296/13, 300/13),
...
m[0].scenes[1].inspirations = [
  // id, name, img, width, height, x, y
  //new Inspiration('children1', 'Crianças', '/img/m0/children1.png', 1112/13, 284/13, 280/13, 300/13),
  //new Inspiration('light1', 'Lâmpada', '/img/m0/light.png', 184/13, 133/13, 875/13, 0),
];
m[0].scenes[1].foregrounds = [
  new Item('/img/m0/prison.svg', '100%', '100%'),
  //new Inspiration('rat1', 'Rato', '/img/m0/rat.png', 96/13, 50/13, 1400/13, 630/13),
];
...
m[0].scenes[4].inspirations = [
  // id, name, img, width, height, x, y
  new Inspiration('dogtag1', 'Dog-tag', '/img/m0/dogtag1.png', 78/13, 42/13, 930/13, 500/13),
  new Inspiration('diary1', 'Diário', '/img/m0/diary1.png', 130/13, 76/13, 1100/13, 630/13),
  new Inspiration('bed1', 'Cama', '/img/m0/bed.png', 602/13, 160/13, 500/13, 200/13),
];
...
m[1].scenes[0].inspirations = [
  ...
  new Inspiration('weapons2', 'Armas', '/img/m0/weapons.svg', 297/13, 171/13, 305/13, 70/13),
  new Inspiration('window2', 'Janela', '/img/m0/window.svg', 152/13, 215/13, 69/13, 57/13),
